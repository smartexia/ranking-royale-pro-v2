      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="font-gaming text-xl md:text-2xl text-gaming-primary mb-4">
            Plataforma Profissional de Torneios
          </p>
          
          <p className="font-gaming-body text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Organize torneios de Call of Duty Mobile com processamento automatizado de resultados, 
            análise de screenshots com IA e rankings profissionais.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="font-gaming-body text-muted-foreground">Torneios</p>
            </div>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="font-gaming-body text-muted-foreground">Times Ativos</p>
            </div>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <h3 className="font-gaming text-2xl text-gaming-danger">IA</h3>
              <p className="font-gaming-body text-muted-foreground">Resultados Automatizados</p>
            </div>
          </div>
        </div>
      </div>
